...
- PostgreSQL: [9.5 Docs](https://www.postgresql.org/docs/9.5/static/index.html), [Query Planner Output Explained](https://gist.github.com/hgmnz/883144) (How to read output generated by PostgreSQL `EXPLAIN`)
- [Redis](http://redis.io/)
